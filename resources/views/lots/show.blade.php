                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Deteexp At </th><td> {{ $lot->deteexp_at }} </td></tr><tr><th> Drug Id </th><td> {{ $lot->drug_id }} </td></tr><tr><th> Cost </th><td> {{ $lot->cost }} </td></tr><tr><th> Stock Im </th><td> {{ $lot->stock_im }} </td></tr>
                                </tbody>
                            </table>
                        </div>
