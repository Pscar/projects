                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Pro Name </th><td> {{ $product->pro_name }} </td></tr><tr><th> Detail </th><td> {{ $product->detail }} </td></tr><tr><th> Sale Price </th><td> {{ $product->sale_price }} </td></tr><tr><th> Drug Id </th><td> {{ $product->drug_id }} </td></tr><tr><th> Category Id </th><td> {{ $product->category_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
